...
class VideosCollectionViewCell: UICollectionViewCell {
    ...
    // MARK: - Property
    static let className: String = "VideosCollectionViewCell"
    
    @IBOutlet weak var backgroundImageView: UIImageView!
    @IBOutlet weak var moreshadowImageView: UIImageView!
    ...
    var video: VideoModel? {
        didSet {
            ...
            likeLb.text = NSLocalizedString("Like:", comment: "") + getLikeLabelValue(like: video!.likes!, dislikes: video!.dislikes!)
