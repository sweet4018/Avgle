...
protocol VideosViewDelegate: NSObjectProtocol {
    
    ///點擊更多
    func videosViewClickMoreBtn(btn: UIButton)
}

class VidoesView: UIView {
    ...
    fileprivate lazy var titleLb: UILabel = {
        ...
        label.text = NSLocalizedString("Videos", comment: "")
    ...
    @objc func displayMore(button: UIButton) {
        ...
        self.delegate?.videosViewClickMoreBtn(btn: button)
    }
